...
**Status: Kern `nc` v0.11.0 · Abteilung `nc-development` v0.2.0 · Abteilung `nc-felix`
...
|---|---|---|---|
| `nc` | **Kern** — ständige Abteilung `gemeinsam`: Session-Zyklus, Infrapflege-Skills, Queue-Flow-Skills (`queue-abteilung`/`queue-kern`), Kontroll-Schicht (Gate 1 + Gate 2 + Gate 3 + Queue-Fälligkeits-Erinnerung), Doks-Autosync, WP-Rahmen, Registry, Formatregeln, `nc-sync.md`, Subagenten (`agents/`) | `/nc:` | 0.11.0 (= `VERSION`) |
