...
- **Status/Grenzen:** **offen** — Dateiname/Format und die Einbindung in `/nc:start` sind
  nicht festgelegt. Kein Memory-Share zwischen affiliate-Satelliten (siehe SSOT-Definition).
