...
| Zwei parallele Stränge belegen denselben Anker (Versionsnummer, Skill-Name) | **GF3 + a + c** — Queue-Zeile | Eigener Agenten-Fehler (GF3, immer Queue), zusätzlich abteilungsübergreifend wirksam (a) und in eine teamweite Regel gemündet (c) — die Begriffsnorm „Anker" steht seit 2026-08-25 in [`os-bau-methode.md`](../standardprozesse/os-bau-methode.md) (Mechanik statt Reservierung, D31) |
