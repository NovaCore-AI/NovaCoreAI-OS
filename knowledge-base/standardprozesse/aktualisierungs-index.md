...
| **Wissens-Router oder Zeiger-Index geändert** (`plugins/nc/skills/wissen-*`, `plugins/nc/hooks/wissen-sucheindex.json`, `plugins/nc/hooks/pfad-aenderungsindex.json`) | die vier Router-SKILL.mds · [`NovaCore-OS-Node-Doks-Definition.md`](../grundwissen/NovaCore-OS-Node-Doks-Definition.md) (Knotenbestand) · dieser Index (Fett-Anker der Matrix) | Router und Indizes **im selben Zug** — eine neue/entfallene Wissensdatei braucht die Sucheindex-Zeile UND ggf. den Router-Zeiger · `CHANGELOG.md` | **Kern-Bump** (alles reist im Plugin-Paket) · testerzwungen: Descriptions-Summe der Router < 6.000 Zeichen, jeder Sucheindex-Pfad existiert im Repo, jeder `matrixKey` des Pfad-Index steht als **Fett-Anker** in diesem Dokument — ein umformulierter Fett-Anker bricht den Pfad-Zeiger-Hook |
