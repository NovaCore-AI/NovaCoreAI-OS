'use strict';
// shell-substitution.js — 1:1-Port aus dem GateGuard-Vorbild (ECC-Plugin ecc@2.0.0,
// scripts/lib/shell-substitution.js, gelesen 2026-07-26). Bewusst unveraendert inkl.
// Original-Kommentaren, damit der Port gegen das Vorbild diffbar bleibt (Design-Spec
// 2026-07-28 §5 (OS-Repo)).
 ...
 * purposes of destructive-bash detection they are equivalent: a `rm -rf`
 * inside `{ ...; }` still executes.
 *
